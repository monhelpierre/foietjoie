...
?>
                        ...
                        <hr/>
                            ...
                            <?php
                                ...
                                ?>
                            <img style="display:none;" src="<?php echo base_url() ?>uploads/school_content/logo/app_logo/<?php echo $settinglist[0]['app_logo']; ?>" class="img-thumbnail" alt="Logo" width="304" height="236">
                            <?php
                                }
                                ?>
                        <br/>
                        <br/>
                        <a href="#schsetting" style="display:none;" role="button" class="btn btn-primary btn-sm upload_logo" data-toggle="tooltip" data-logo_type="app_logo"  title="<?php echo $this->lang->line('edit'); ?> <?php echo $this->lang->line('mobile_app_logo'); ?>" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><i class="fa fa-picture-o"></i> <?php echo $this->lang->line('edit'); ?> <?php echo $this->lang->line('mobile_app_logo'); ?></a>
...
?>
                                <tbody>
                                    <tr>
                                        <td><strong>Nom de l'instutition</strong></td>
                                    ...
                                    <tr>
                                        <td><strong>Code de l'instutition</strong></td>
                                        <td class="mailbox-name"> <?php echo $settinglist[0]['dise_code'] ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Ann&eacute;e en cours</strong></td>
                                        <td class="mailbox-name">
                                            <?php echo $settinglist[0]['current_session']['session']; ?></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Mois de début année en cours</strong></td>
                                        <td class="mailbox-name">
                                            <?php
                ...
                <div class="row">
                    <form role="form" id="schsetting_form"  action="<?php echo site_url('schsettings/ajaxedit') ?>">
                        ...
                        <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            <label for="name">Nom l'instutition</label><small class="req"> *</small>
                        ...
                        <div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            <label for="dise_code">Code l'instutition</label>
                        ...
                        <div class="form-group col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <label for="sender_id">Année en cours</label><small class="req"> *</small>
                        ...
                        <div class="form-group  col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <label for="exampleInputEmail1">Mois de début année en cours</label><small class="req"> *</small>
                        ...
                        <div class="form-group  col-xs-6 col-sm-6 col-md-6 col-lg-6" style="display:none;">
...
?>
                        ...
                        <div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('currency'); ?></label><small class="req"> *</small>
                             <input type="text" name="sch_currency" id="currency" class="form-control">
                        ...
                        <div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-6" style="display:none;">
    ...
    $('.edit_setting').on('click', function (e) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $('input[name="sch_currency"]').val(result.currency);
