...
<script type="text/javascript">
    $('#form1').submit(function () {
        var c = confirm("Êtes-vous sûr de vouloir faire une sauvegarde maintenant?");
        return c;
    });
    $('.formdelete').submit(function () {
        var c = confirm("Êtes-vous sûr de vouloir supprimer la sauvegarde?");
        return c;
    });
    $('.formrestore').submit(function () {
        var c = confirm("Êtes-vous sûr de vouloir restaurer la sauvegarde?");
        return c;
    });
