                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <!--   <img src="<?php echo base_url(); ?>backend/images/s_logo.png" class="logowidth"> -->
                                     <span class="logo-lg" title="SYSteme GEStion UNIVersiataire" style="font-size: 30px;color: #3fa534; font-style: all; font-weight: bold; " >UNEPH</span><br>
                                      <small class="logo-mini" title="SYSteme GEStion UNIVersiataire" style="font-size: 20px;color: #FFF; font-style: all; font-weight: bold; " >Université Episcopale D'Haiti</small>
                        </div>
                    </div>
                    <div class="row">
