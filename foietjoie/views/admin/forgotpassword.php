...
<html lang="en">
    <head>
        ...
        <title>UNEPH | UNIVERSITE EPISCOPALE D'HAITI<</title>
        <!--favican-->
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <!--   <img src="<?php echo base_url(); ?>backend/images/s_logo.png" class="logowidth"> -->
                                     <span class="logo-lg" title="SYSteme GEStion UNIVersitaire" style="font-size: 30px;color: #3fa534; font-style: all; font-weight: bold; " >UNEPH</span><br>
                                      <small class="logo-mini" title="SYSteme GEStion UNIVersitaire" style="font-size: 20px;color: #FFF; font-style: all; font-weight: bold; " >Université Episcopale D'Haiti</small>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="form-bottom">
                                ...
                                <form action="<?php echo site_url('site/forgotpassword') ?>" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" placeholder="<?php echo $this->lang->line('email'); ?>" class="form-username form-control" id="form-username">
                                        <span class="text-danger"><?php echo form_error('email'); ?></span>
                                    </div>
                                    <button type="submit" class="btn"><?php echo $this->lang->line('submit'); ?></button>
                                </form>
                                <a href="<?php echo site_url('site/login') ?>" class="forgot"><i class="fa fa-key"></i>Retour au connexion</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.backstretch([
            base_url + "backend/usertemplate/assets/img/backgrounds/img_11.jpg"
