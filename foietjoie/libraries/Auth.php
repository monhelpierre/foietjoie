...
class Auth
{
    ...
    public function reset_password($email)
    {
        ...
        if ($admin) {
            ...
            $this->CI->email->message('Votre mot de passe a été réinitialisé sur ' . $new_password . '.');
            $this->CI->email->send();
            return true;
        } else {
            return false;
    ...
    public function delete($id)
    {
        if ($this->check_id($id)) {
            ...
            return $admin->firstname . ' ' . $admin->lastname . ' a été retiré.';
        } else {
            return 'L\'administrateur n\'a pas pu être trouvé.';
        }
    }
